...
var setup = function (editor, url) {
    ...
    function insertFootnote(selectedText, footnoteText) {
        ...
        var footnoteMarker = "<span>".concat(selectedText, "<a id=\"footnote-entry-").concat(footnoteId, "-ref\" role=\"doc-noteref\" aria-labelledby=\"footnote-entry-").concat(footnoteId, "\" href=\"#footnote-entry-").concat(footnoteId, "\"><sup>[").concat(footnoteNumber, "]</sup></a></span>");
        var footnoteContent = "\n            <li id=\"footnote-entry-".concat(footnoteId, "\">\n                <a id=\"footnote-entry-").concat(footnoteId, "\">\n                    \n                </a>\n                ").concat(footnoteText, "\n                <a role=\"doc-backlink\" href=\"#footnote-entry-").concat(footnoteId, "-ref\" aria-label=\"Back to content\">\u21B5</a>\n            </li>");
    ...
    function removeOrphanFootnotes() {
        var footnoteRefs = editor.dom.select('a[role="doc-noteref"]');
        var footnoteIds = footnoteRefs.map(function (ref) { return ref.id.replace('-ref', ''); });
        var footnotes = editor.dom.select('li[id^="footnote-"]');
        ...
        var footnotesSection = editor.dom.select('section[role="doc-footnotes"]')[0];
